  ...
  return (
    ...
    >
      ...
      <div className="relative w-full px-4 md:px-8">
        <h2 className="bg-gradient-to-b font-montserrat from-neutral-900 to-neutral-700 bg-clip-text text-center text-xl font-bold tracking-tight text-transparent md:text-4xl dark:from-white dark:to-neutral-200">
...
export function Pricing() {
  ...
  return (
    <div className="relative">
      <div className="relative z-20 mx-auto mt-4 grid grid-cols-1 items-center border-t  border-neutral-200 bg-neutral-100 px-4 md:mt-20 md:grid-cols-2 md:px-24 xl:grid-cols-3 dark:border-neutral-800 dark:bg-neutral-950">
