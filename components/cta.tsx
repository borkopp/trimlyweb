...
export function CTAWithDashedGridLines() {
  return (
    <section className="w-full grid grid-cols-1 md:grid-cols-3 my-20 md:my-40 md:mb-60 justify-start relative z-20 max-w-7xl mx-auto bg-gradient-to-br from-gray-100 to-white dark:from-neutral-900 dark:to-neutral-950">
      ...
      <div className="md:col-span-2 p-8 md:p-14">
        <h2 className="text-left font-montserrat text-neutral-500 dark:text-neutral-200 text-xl md:text-3xl tracking-tight font-medium">
          Ready to modernize your barbershop?{" "}
          <span className="font-bold text-black dark:text-white">
            Let&apos;s talk
          </span>
        </h2>
        <p className="text-left text-neutral-500 mt-4 max-w-lg font-lato dark:text-neutral-200 text-xl md:text-3xl  font-medium">
          Get your own branded app and dashboard to manage your barbershop.
        </p>
