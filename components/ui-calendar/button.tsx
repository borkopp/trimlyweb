  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-colors disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      ...
      variant: {
        ...
        primary: "bg-primary text-white hover:bg-primary-700 disabled:bg-bg-disabled disabled:text-t-disabled",
        outline: "border bg-backgroundMuted hover:bg-bg-primary-hover disabled:text-t-disabled disabled:opacity-50 disabled:hover:bg-transparent",
