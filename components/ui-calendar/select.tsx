...
const SelectTrigger = forwardRef<TSelectTriggerRef, TSelectTriggerProps>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "group flex h-9 w-full items-center justify-between rounded-md border border-b-primary bg-backgroundMuted px-3 py-2 text-sm",
...
const SelectContent = forwardRef<TSelectContentRef, TSelectContentProps>(({ className, children, viewportClassName, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position="popper"
      className={cn(
        "relative z-50 max-h-96 overflow-hidden rounded-md border border-b-primary bg-backgroundMuted",
