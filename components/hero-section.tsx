                        ...
                        <div className="perspective-distant -mr-16 pl-16 lg:-mr-56 lg:pl-56">
                            <div className="[transform:rotateX(20deg);]">
                                <div className="lg:h-176 relative skew-x-[.36rad]">
                                    ...
                                    <Image className="rounded-(--radius) z-1 relative border dark:hidden" src="/dash.png" alt="tailus ui hero section" width={2880} height={2074} />
                                    <Image className="rounded-(--radius) z-1 relative hidden border dark:block" src="/dash.png" alt="tailus ui hero section" width={2880} height={2074} />
                                </div>
                            </div>
                        </div>
                    </div>
