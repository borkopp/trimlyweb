...
export function HeroSectionWithBeamsAndGrid() {
  ...
  return (
    ...
    >
      ...
      <h2 className="relative z-20 mx-auto mb-4 mt-4 max-w-4xl text-balance text-center text-3xl font-semibold tracking-tight text-gray-700 md:text-7xl dark:text-neutral-300">
        <Balancer>
          The upgrade your
          <div className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
            <div className="text-black [text-shadow:0_0_rgba(0,0,0,0.1)] dark:text-white">
              <span className="">barbershop deserves.</span>
            </div>
          </div>
        </Balancer>
      </h2>
      <p className="relative z-50 mx-auto mt-4 max-w-lg px-4 text-center text-base/6 text-gray-600 dark:text-gray-200">
        Empowering barbershops to shine with their own branded app. Simplify
        scheduling and attract more clients!
      </p>
      ...
      <div className="absolute hidden dark:block bottom-0 left-0 right-0 h-80 bg-gradient-to-t from-background via-background/90 to-transparent z-30"></div>
    </div>
  );
}
