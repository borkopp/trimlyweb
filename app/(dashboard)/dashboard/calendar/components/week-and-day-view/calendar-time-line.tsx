...
export function CalendarTimeline() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -left-[4.5rem] flex w-16 -translate-y-1/2 justify-end bg-background pr-1 text-xs font-medium text-primary-600 dark:text-primary-700">
        {formatCurrentTime()}
      </div>
    </div>
  );
