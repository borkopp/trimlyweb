...
import { DayPicker } from "@/components/ui-calendar/day-picker";
import { ScrollArea } from "@/components/ui-calendar/scroll-area";
    ...
    <div className="flex h-full">
      ...
      <div className="hidden w-72 divide-y border-l md:block">
        ...
        <div className="flex-1 space-y-3">
          ...
          {currentEvents.length > 0 && (
            <div className="h-[422px] px-4 overflow-auto">
