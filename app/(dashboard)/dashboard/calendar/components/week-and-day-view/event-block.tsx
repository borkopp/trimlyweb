  ...
  "flex select-none flex-col gap-0.5 truncate whitespace-nowrap rounded-md border px-2 py-1.5 text-xs focus-visible:outline-offset-2",
  {
    variants: {
      color: {
        ...
        // Dot variants
        "blue-dot": "bg-backgroundMuted text-t-primary [&_svg]:fill-blue-600",
        "green-dot": "bg-backgroundMuted text-t-primary [&_svg]:fill-green-600",
        "red-dot": "bg-backgroundMuted text-t-primary [&_svg]:fill-red-600",
        "orange-dot": "bg-backgroundMuted text-t-primary [&_svg]:fill-orange-600",
        "purple-dot": "bg-backgroundMuted text-t-primary [&_svg]:fill-purple-600",
        "yellow-dot": "bg-backgroundMuted text-t-primary [&_svg]:fill-yellow-600",
      },
    },
    defaultVariants: {
      color: "blue-dot",
